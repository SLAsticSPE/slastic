...
public class TestUsageAndAssemblyModelUpdaterBookstoreTracesWithLoops extends TestCase {
	...
	private final TraceReconstructor traceReceiver =
			new TraceReconstructor(this.epService, TestUsageAndAssemblyModelUpdaterBookstoreTracesWithLoops.TRACE_DETECTION_TIMEOUT_MILLIS);
	...
	private void checkSystemModel() {
		...
		Assert.assertEquals("Unexpected interface of asmConnect_bookstore_catalog", catalogInterface, asmConnect_bookstore_catalog.getConnectorType().getInterface());
		...
		final SystemProvidedInterfaceDelegationConnector sysProvDelegConnector =
				assemblyModelManager.lookupProvidedInterfaceDelegationConnector(bookstoreAssembly, bookstoreInterfaceSignature);
		...
		for (final BookstoreTraceWithLoopsConfiguration traceConfiguration : this.traceConfigurations) {
			...
			expectedOpCallFreq_CRM_getOffers +=
					traceConfiguration.getNumTraces() * traceConfiguration.getNumCalls_BookstoreSearchBook_CrmGetOffers();
