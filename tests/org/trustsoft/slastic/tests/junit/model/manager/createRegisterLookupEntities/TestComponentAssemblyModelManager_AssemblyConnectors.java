 ...
 */
public class TestComponentAssemblyModelManager_AssemblyConnectors extends
		AbstractSubmodelManagerCreateRegisterLookupFQNEntityTest<ComponentAssemblyModel, AssemblyComponentConnector> {
	...
	@Override
	protected AssemblyComponentConnector createAndRegisterEntity(final AbstractModelManager<ComponentAssemblyModel> mgr, final String fqEntityName,
