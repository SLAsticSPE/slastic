 ...
 */
public class TestRepositoryModelManager_ComponentTypes extends AbstractSubmodelManagerCreateRegisterLookupEntityTest<TypeRepositoryModel, ComponentType> {

    private static final Log log = LogFactory.getLog(TestRepositoryModelManager_ComponentTypes.class);
