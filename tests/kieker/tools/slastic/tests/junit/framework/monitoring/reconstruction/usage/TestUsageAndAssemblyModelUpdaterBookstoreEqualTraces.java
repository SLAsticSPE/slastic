...
public class TestUsageAndAssemblyModelUpdaterBookstoreEqualTraces extends TestCase {
	...
	public void testUsageAndAssemblyModelUpdater() throws InterruptedException, IOException {
		this.sendBookstoreTraces(NUM_VALID_TRACES_TO_GENERATE);
	...
	private void checkSystemModel() {
		...
		Assert.assertEquals("Unexpected number of system-provided interfaces", 1, assemblyModelManager.getSystemProvidedInterfaces().size());
		...
		Assert.assertEquals("Unexpected number of calls to Catalog operation",
				2 * NUM_VALID_TRACES_TO_GENERATE,
		...
		this.compareFrequencyDistribution(fdBookstoreCatalog, new Long[] { 1l }, new Long[] { NUM_VALID_TRACES_TO_GENERATE + 0l });
		...
		this.compareFrequencyDistribution(fdBookstoreCRM, new Long[] { 1l }, new Long[] { NUM_VALID_TRACES_TO_GENERATE + 0l });
		...
		this.compareFrequencyDistribution(fdCrmCatalog, new Long[] { 1l }, new Long[] { NUM_VALID_TRACES_TO_GENERATE + 0l });
	}
	...
	private void sendBookstoreTraces(final int numTraces) {
		...
		final List<DeploymentComponentOperationExecution> bookstoreExecutions =
				new ArrayList<DeploymentComponentOperationExecution>(numTraces * BookstoreTraceFactory.NUM_EXECUTIONS_PER_TRACE);
