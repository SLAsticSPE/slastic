...
analysis.component.rel.dir="PerformanceEvaluatorComponent-net.voorn.wosp.control.performanceEvaluation.EWETELPerformanceEvaluator/net.voorn.wosp.control.performanceEvaluation.performanceLogger.PerformanceLogger/net.voorn.wosp.control.performanceEvaluation.performanceLogger.AssemblyComponentOperationExecutionCountLogger/"
analysis.data.rel.fn="5--de.ewetel.b2b.backend.service.css.EmailService-de.ewetel.b2b.backend.service.css.EmailService__T.csv"
...
plot(data.df[["posixct"]], data.df[["count"]], col="blue", type="h", xaxt="n", xlab="", lwd=1, ylab="Arrival rate [#/5 min.]", main="Arrival Rates (Assembly Component Operation Execution)",cex.axis=0.95) #yaxt="n",
