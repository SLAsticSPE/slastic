...
analysis.component.rel.dir="PerformanceEvaluatorComponent-net.voorn.wosp.control.performanceEvaluation.EWETELPerformanceEvaluator/net.voorn.wosp.control.performanceEvaluation.performanceLogger.PerformanceLogger/net.voorn.wosp.control.performanceEvaluation.performanceLogger.DeploymentComponentAvgRTsLogger/"
...
plot(data.df[["posixct"]], data.df[["avgRTMillis"]], col="blue", type="h", xaxt="n", xlab="", lwd=1, ylab="Response time [milliseconds]", main="Avg. Operation Response Times (Deployment Level)",cex.axis=0.95) #yaxt="n",
