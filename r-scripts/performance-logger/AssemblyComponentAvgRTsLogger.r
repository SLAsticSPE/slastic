...
analysis.component.rel.dir="PerformanceEvaluatorComponent-net.voorn.wosp.control.performanceEvaluation.EWETELPerformanceEvaluator/net.voorn.wosp.control.performanceEvaluation.performanceLogger.PerformanceLogger/net.voorn.wosp.control.performanceEvaluation.performanceLogger.AssemblyComponentAvgRTsLogger/"
...
plot(data.df[["posixct"]], data.df[["avgRTMillis"]], col="blue", type="h", xaxt="n", xlab="", lwd=1, ylab="Response time [milliseconds]", main="Avg. Operation Response Times (Assembly Level)",cex.axis=0.95) #yaxt="n",
