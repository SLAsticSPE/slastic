...
public class EucalyptusApplicationCloudingService implements IApplicationCloudingService {
	...
	public ICloudNode allocateNode(final String name, final ICloudNodeType type)
		...
		final EucalyptusCommand setHostnameCommand =
				EucalyptusCommandFactory.getSetHostnameCommand(this.configuration.getSSHPrivateKeyFile(),
						this.configuration.getSSHUserName(), ipAddress);
		executer.executeCommandWithEnv(setHostnameCommand, this.configuration.getEucatoolsPath());
	...
	public IApplicationInstance deployApplicationInstance(final ICloudedApplication application,
		...
		EucalyptusCommand startComponentCommand = null;
		
		if (application.getName().contains(EucalyptusApplicationCloudingService.WEBSTORE_REST_NAME)) {
		...
		executer.executeCommandWithEnv(startComponentCommand, this.configuration.getEucatoolsPath());
