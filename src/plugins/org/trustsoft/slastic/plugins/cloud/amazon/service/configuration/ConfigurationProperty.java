package org.trustsoft.slastic.plugins.cloud.amazon.service.configuration;
...
public enum ConfigurationProperty {
	...
	/* */
	EC2TOOLS_PATH("ec2toolsPath", "/usr/local/bin/",
			/* allow empty: */ true),

	/* */
	// TODO: Does this default value make any sense?
	AMA_AMIS("amis", "app-server:ami-ABCDEFGH;db-server:ami-IJKLMNOP",
			/* NOT allow empty: */ false),
	...
	/* */
	AMA_KEY_NAME("amazonKeyName", "myKey",
			/* NOT allow empty: */ false),

	/* */
	AMA_GROUP("amazonGroup", "default",
			/* NOT allow empty: */ false),
