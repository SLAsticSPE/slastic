...
public class KiekerMonitoringManager extends AbstractSLAsticMonitoringManager {
	private static final Log log = LogFactory
			.getLog(KiekerMonitoringManager.class);
	...
	private void init() throws IllegalArgumentException {
		String logReaderClassnameProperty = this
				.getInitProperty(TPMON_LOG_READER_CLASSNAME_PROPERTY);
	...
	private IKiekerMonitoringLogReader loadAndInitTpmonLogReaderInstanceFromClassname(
		...
		try {
			Class<IKiekerMonitoringLogReader> cl = (Class<IKiekerMonitoringLogReader>) Class
					.forName(classname);
			inst = cl.newInstance();
