...
public class DeploymentComponentAvgRTsLogger extends AbstractPerformanceMeasureLogger<DeploymentComponentOperationPair>
	 ...
	 */
	public DeploymentComponentAvgRTsLogger(final IComponentContext context, final int winTimeSec, final int outputIntervalSec, final boolean ioFlushAfterEachRecord) {
