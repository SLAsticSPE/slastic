 ...
 * 
 */
public class AssemblyComponentOperationAvgRTsLogger extends AbstractPerformanceMeasureLogger<AssemblyComponentOperationPair>
	...
	public AssemblyComponentOperationAvgRTsLogger(final IComponentContext context) {
	 ...
	 */
	public AssemblyComponentOperationAvgRTsLogger(final IComponentContext context, final int winTimeSec, final int outputIntervalSec, final boolean ioFlushAfterEachRecord) {
