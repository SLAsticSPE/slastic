...
public class SimulationController {
    ...
    private final IMonitoringRecordConsumerPlugin recordConsumerPluginPort = new IMonitoringRecordConsumerPlugin() {
        ...
        public void start() {
            exp.stop(stopCond = new StopCondition(model, model.getName(), Constants.DEBUG));
            CallHandler.getInstance().setStopCond(stopCond);
        ...
        public boolean newMonitoringRecord(IMonitoringRecord record) {
            ...
            if (record instanceof OperationExecutionRecord) {
                ...
                log.info("Last record read, marking termination");
                queue.finish();
    ...
    private final IReconfPlanReceiver reconfigurationPlanReceiverPort =
            new IReconfPlanReceiver() {
