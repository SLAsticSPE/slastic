 ...
 * <ul>
 *   <li>{@link de.cau.se.slastic.metamodel.usage.CallingRelationship#getCalledInterface <em>Called Interface</em>}</li>
 *   <li>{@link de.cau.se.slastic.metamodel.usage.CallingRelationship#getCalledSignature <em>Called Signature</em>}</li>
 *   <li>{@link de.cau.se.slastic.metamodel.usage.CallingRelationship#getCallingOperation <em>Calling Operation</em>}</li>
 *   <li>{@link de.cau.se.slastic.metamodel.usage.CallingRelationship#getFrequencyDistribution <em>Frequency Distribution</em>}</li>
 * </ul>
 * </p>
 *
 * @see de.cau.se.slastic.metamodel.usage.UsagePackage#getCallingRelationship()
 * @model
 * @generated
 */
public interface CallingRelationship extends EObject {
	 ...
	 * @see de.cau.se.slastic.metamodel.usage.UsagePackage#getCallingRelationship_CalledInterface()
	...
	/**
	 * Sets the value of the '{@link de.cau.se.slastic.metamodel.usage.CallingRelationship#getCalledInterface <em>Called Interface</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see de.cau.se.slastic.metamodel.usage.UsagePackage#getCallingRelationship_CalledSignature()
	 * @model required="true" ordered="false"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link de.cau.se.slastic.metamodel.usage.CallingRelationship#getCalledSignature <em>Called Signature</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see de.cau.se.slastic.metamodel.usage.UsagePackage#getCallingRelationship_CallingOperation()
	 * @model required="true" ordered="false"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link de.cau.se.slastic.metamodel.usage.CallingRelationship#getCallingOperation <em>Calling Operation</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see de.cau.se.slastic.metamodel.usage.UsagePackage#getCallingRelationship_FrequencyDistribution()
	...
	/**
	 * Sets the value of the '{@link de.cau.se.slastic.metamodel.usage.CallingRelationship#getFrequencyDistribution <em>Frequency Distribution</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
