 ...
 * <ul>
 *   <li>{@link de.cau.se.slastic.metamodel.adaptation.WorkloadForecasting#getControl <em>Control</em>}</li>
 * </ul>
 * </p>
 *
 * @see de.cau.se.slastic.metamodel.adaptation.AdaptationPackage#getWorkloadForecasting()
 * @model
 * @generated
 */
public interface WorkloadForecasting extends EObject {
	 ...
	 * It is bidirectional and its opposite is '{@link de.cau.se.slastic.metamodel.adaptation.Control#getWorkloadForecaster <em>Workload Forecaster</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see de.cau.se.slastic.metamodel.adaptation.AdaptationPackage#getWorkloadForecasting_Control()
	...
	/**
	 * Sets the value of the '{@link de.cau.se.slastic.metamodel.adaptation.WorkloadForecasting#getControl <em>Control</em>}' container reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
