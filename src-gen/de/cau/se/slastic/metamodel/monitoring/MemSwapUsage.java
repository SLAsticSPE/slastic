 ...
 * <ul>
 *   <li>{@link de.cau.se.slastic.metamodel.monitoring.MemSwapUsage#getMemUsedBytes <em>Mem Used Bytes</em>}</li>
 *   <li>{@link de.cau.se.slastic.metamodel.monitoring.MemSwapUsage#getMemFreeBytes <em>Mem Free Bytes</em>}</li>
 *   <li>{@link de.cau.se.slastic.metamodel.monitoring.MemSwapUsage#getSwapUsedBytes <em>Swap Used Bytes</em>}</li>
 *   <li>{@link de.cau.se.slastic.metamodel.monitoring.MemSwapUsage#getSwapFreeBytes <em>Swap Free Bytes</em>}</li>
 * </ul>
 * </p>
 *
 * @see de.cau.se.slastic.metamodel.monitoring.MonitoringPackage#getMemSwapUsage()
 * @model
 * @generated
 */
public interface MemSwapUsage extends ResourceMeasurement {
	 ...
	 * @see de.cau.se.slastic.metamodel.monitoring.MonitoringPackage#getMemSwapUsage_MemUsedBytes()
	...
	/**
	 * Sets the value of the '{@link de.cau.se.slastic.metamodel.monitoring.MemSwapUsage#getMemUsedBytes <em>Mem Used Bytes</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see de.cau.se.slastic.metamodel.monitoring.MonitoringPackage#getMemSwapUsage_MemFreeBytes()
	 * @model required="true" ordered="false"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link de.cau.se.slastic.metamodel.monitoring.MemSwapUsage#getMemFreeBytes <em>Mem Free Bytes</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see de.cau.se.slastic.metamodel.monitoring.MonitoringPackage#getMemSwapUsage_SwapUsedBytes()
	 * @model required="true" ordered="false"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link de.cau.se.slastic.metamodel.monitoring.MemSwapUsage#getSwapUsedBytes <em>Swap Used Bytes</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see de.cau.se.slastic.metamodel.monitoring.MonitoringPackage#getMemSwapUsage_SwapFreeBytes()
	 * @model required="true" ordered="false"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link de.cau.se.slastic.metamodel.monitoring.MemSwapUsage#getSwapFreeBytes <em>Swap Free Bytes</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
