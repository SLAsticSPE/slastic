 ...
 * <ul>
 *   <li>{@link de.cau.se.slastic.metamodel.qos.impl.CostProfileImpl#getQoSModel <em>Qo SModel</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CostProfileImpl extends EObjectImpl implements CostProfile {
	...
	protected EClass eStaticClass() {
		return QosPackage.Literals.COST_PROFILE;
	}
	...
	public NotificationChain basicSetQoSModel(QoSModel newQoSModel, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newQoSModel, QosPackage.COST_PROFILE__QO_SMODEL, msgs);
		return msgs;
	}
	...
	public void setQoSModel(QoSModel newQoSModel) {
		if (newQoSModel != eInternalContainer() || (eContainerFeatureID() != QosPackage.COST_PROFILE__QO_SMODEL && newQoSModel != null)) {
			...
			if (newQoSModel != null)
				msgs = ((InternalEObject)newQoSModel).eInverseAdd(this, QosPackage.QO_SMODEL__COST_PROFILE, QoSModel.class, msgs);
			msgs = basicSetQoSModel(newQoSModel, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QosPackage.COST_PROFILE__QO_SMODEL, newQoSModel, newQoSModel));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case QosPackage.COST_PROFILE__QO_SMODEL:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case QosPackage.COST_PROFILE__QO_SMODEL:
				return eInternalContainer().eInverseRemove(this, QosPackage.QO_SMODEL__COST_PROFILE, QoSModel.class, msgs);
		}
