 ...
 * <ul>
 *   <li>{@link de.cau.se.slastic.metamodel.qos.QoSObservations#getQoSModel <em>Qo SModel</em>}</li>
 * </ul>
 * </p>
 *
 * @see de.cau.se.slastic.metamodel.qos.QosPackage#getQoSObservations()
 * @model
 * @generated
 */
public interface QoSObservations extends EObject {
	 ...
	 * It is bidirectional and its opposite is '{@link de.cau.se.slastic.metamodel.qos.QoSModel#getQosObservations <em>Qos Observations</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see de.cau.se.slastic.metamodel.qos.QosPackage#getQoSObservations_QoSModel()
	...
	/**
	 * Sets the value of the '{@link de.cau.se.slastic.metamodel.qos.QoSObservations#getQoSModel <em>Qo SModel</em>}' container reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
