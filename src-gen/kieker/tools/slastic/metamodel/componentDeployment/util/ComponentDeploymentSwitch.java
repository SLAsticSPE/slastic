 ...
 * @generated
 */
public class ComponentDeploymentSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	public ComponentDeploymentSwitch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ComponentDeploymentPackage.DEPLOYMENT_COMPONENT: {
				...
				if (result == null) result = caseEntity(deploymentComponent);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ComponentDeploymentPackage.COMPONENT_DEPLOYMENT_MODEL: {
				ComponentDeploymentModel componentDeploymentModel = (ComponentDeploymentModel)theEObject;
				T result = caseComponentDeploymentModel(componentDeploymentModel);
				if (result == null) result = caseSLAsticModel(componentDeploymentModel);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	 ...
	 * @generated
	 */
	public T caseComponentDeploymentModel(ComponentDeploymentModel object) {
		return null;
	}
